 (function($) {
    $.fn.windstag = function (options) {
        ...
        // every 30 ms to call setPosition()
        ...
        function setPosition() {
            ...
            // set div left top font-size ,filter,opacity,z-index
            items.each(function(i) {
