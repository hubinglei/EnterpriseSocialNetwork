...
function loadDay(target,options){
  ...
  function loadMonth(target,options){
   ...
   function loadDay11(target,options){
	  return {data:[
						  [31, 20, 42, 39, 45, 17, 50,73,15,99]
						  ],xlabel:['Day1','Day2','Day3','Day4','Day5','Day6','Day7','Day8','Day9','Day10']}
  }
  function loadWeek11(target,options){
	  return {data:[
	                	  [40, 90, 42, 29, 45, 67, 10, 55, 20, 40]
						  ],xlabel:['Week1','Week2','Week3','Week4','Week5','Week6','Week7','Week8','Week9','Week10']}
  }
  function loadMonth11(target,options){
	  return {data:[  	  
	                  	  [50, 90, 42, 29, 65, 17, 50, 10, 75, 65]
						  ],xlabel:['Month1','Month2','Month3','Month4','Month5','Month6','Month7','Month8','Month9','Month10']}
  }
    ...
    function loadDay12(target,options){
	  return {data:[
						  [31, 10, 82, 39, 45, 27, 50,73,15,99]
						  ],xlabel:['Day1','Day2','Day3','Day4','Day5','Day6','Day7','Day8','Day9','Day10']}
  }
  function loadWeek12(target,options){
	  return {data:[
	                	  [50, 90, 42, 29, 25, 27, 10, 55, 20, 10]
						  ],xlabel:['Week1','Week2','Week3','Week4','Week5','Week6','Week7','Week8','Week9','Week10']}
  }
  function loadMonth12(target,options){
	  return {data:[  	  
	                  	  [50, 90, 22, 29, 15, 67, 20, 90, 75, 15]
						  ],xlabel:['Month1','Month2','Month3','Month4','Month5','Month6','Month7','Month8','Month9','Month10']}
  }
	  ...
	  return {data:[
						  [11, 10, 62, 39, 45, 27, 70,73,15,99]
						  ],xlabel:['Day1','Day2','Day3','Day4','Day5','Day6','Day7','Day8','Day9','Day10']}
  }
  function loadWeek13(target,options){
	  return {data:[
	                	  [50, 30, 42, 39, 25, 37, 10, 65, 20, 10]
						  ],xlabel:['Week1','Week2','Week3','Week4','Week5','Week6','Week7','Week8','Week9','Week10']}
  }
  function loadMonth13(target,options){
	  return {data:[  	  
	                  	  [30, 30, 22, 29, 15, 67, 60, 90, 75, 15]
						  ],xlabel:['Month1','Month2','Month3','Month4','Month5','Month6','Month7','Month8','Month9','Month10']}
  }
...
function loadWeekMap1(target,options){
	  return {data:[ {name:'XJ',value:10},
	                {name:'XZ',value:20},
	                {name:'YN',value:30},
	                {name:'NMG',value:80}],updateTime:'Week'}
}
...
function loadMonthMap1(target,options){
	  return {data:[{name:'GX',value:60},
	                {name:'GZ',value:70},
	                {name:'NMG',value:80},
	                {name:'HLJ',value:90}],updateTime:'Month'};
}
